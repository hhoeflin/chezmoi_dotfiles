...
vim.api.nvim_set_keymap("n", "<leader>fg", ":lua require('telescope.builtin').live_grep({grep_open_files=true})<cr>", {silent=true, noremap=true})
...
vim.api.nvim_set_keymap("n", "<leader>ldd", ":lua require('telescope.builtin').diagnostics({bufnr=0})<cr>", {silent=true, noremap=true})
vim.api.nvim_set_keymap("n", "<leader>lwd", ":lua require('telescope.builtin').diagnostics()<cr>", {silent=true, noremap=true})
